...
Также стоит включать **session.cookie_httponly** -  запретить чтение и модификацию кук для JS. Это позволит ибежать основной пробелмы при XSS - угона поьлзовательской сессии.
