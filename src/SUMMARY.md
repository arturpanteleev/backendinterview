...
* [Аутентификация](auth/README.md)
  * [Этапы входа в систему](auth/steps/README.md)
    * [Идентификация](auth/steps/identification.md)
    * [Аутентификация](auth/steps/authentication.md)
    * [Авторизация](auth/steps/authorization.md)
  * [Методы аутентификации](auth/webAuth/README.md)
    * [HTTP Basic](auth/webAuth/httpBasic.md)
    * [HTTP Digest](auth/webAuth/httpDigest.md)
    * [На основе Cookie и сессий](auth/webAuth/cookieSessions.md)
    * [На основе токенов](auth/webAuth/token.md)
    * [С помощью одноразовых паролей (One-Time Passwords, OTP)](auth/webAuth/otp.md)
    * [OAuth](auth/webAuth/oauth.md)
