...
* [Аутентификация](auth/README.md)
    * [Этапы входа в систему](steps/README.md)
        * [Идентификация](steps/identification.md)
        * [Аутентификация](steps/authentication.md)
        * [Авторизация](steps/authorization.md)
    * [Методы аутентификации](webAuth/README.md)
        * [HTTP Basic](webAuth/httpBasic.md)
        * [HTTP Digest](webAuth/httpDigest.md)
        * [На основе Cookie и сессий](webAuth/cookieSessions.md)
        * [На основе токенов](webAuth/token.md)
        * [С помощью одноразовых паролей (One-Time Passwords, OTP)](webAuth/otp.md)
        * [OAuth](webAuth/oauth.md)
