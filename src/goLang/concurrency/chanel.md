...
Когда горутина осуществляет попытку записи в канал, буфер которого полон, рантайм переводит эту горутину в состояние “waiting” и добавляет её в очередь `sendq`
...
Вспомогательная структура *sudog:*
