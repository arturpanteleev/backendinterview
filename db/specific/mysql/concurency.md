...
- **gap lock** — блокировка промежутка между записями индекса, или промежутка перед первой или после последней записью индекса.  
- **next-key lock** — блокировка записи индекса и промежутка перед ней, по сути является комбинацией двух предыдущих типов.
